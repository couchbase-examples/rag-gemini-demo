...
api_key = "AIzaSyBGWsUKYhXAdST1MvlaRsxyzPGssQpKNgA"
...
if __name__ == "__main__":
    ...
    if st.session_state.auth:
        ...
        emd = embedding.embed_query("What's our Q1 revenue?")
        emd2 = embedding.embed_query("What's our ?")
        print(len(emd))
        print(len(emd2))
        ...
        llm = GoogleGenerativeAI(temperature=0.1, model="models/gemini-pro", google_api_key=api_key)
        ...
        llm_without_rag = GoogleGenerativeAI(temperature=0, model="models/gemini-pro", google_api_key=api_key)
        ...
        with st.sidebar:
            ...
            st.markdown(
                "For RAG, we are using [Langchain](https://langchain.com/), [Couchbase Vector Search](https://couchbase.com/) & [Gemini](https://openai.com/). We fetch parts of the PDF relevant to the question using Vector search & add it as the context to the LLM. The LLM is instructed to answer based on the context from the Vector Store."
            )
